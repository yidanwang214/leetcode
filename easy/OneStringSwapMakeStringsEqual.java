...
public class OneStringSwapMakeStringsEqual {
    // https://leetcode.com/problems/check-if-one-string-swap-can-make-strings-equal/solutions/1108695/java-100-faster-runtime-memory-i-bet-the-easiest-to-understand/
    ...
    // https://leetcode.com/problems/check-if-one-string-swap-can-make-strings-equal/solutions/1108610/my-java-solution-0ms/
    ...
    // 1 pointer that iterate through s1 and s2 at the same time
    ...
    // brute force: get the permution of every 2 letters in s1 and change swap them,
